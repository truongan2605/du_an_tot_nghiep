            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card shadow-sm border-0 mb-4">
                        <div
                            class="card-header bg-white border-0 p-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
                            {{-- Left: Booking Info --}}
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-muted small">Tạo lúc:
                                        {{ $formatDateVi($booking->created_at, 'd M Y H:i') }}</div>
                                </div>
                            </div>
                            ...
                            <div class="text-end d-flex flex-column align-items-end gap-2">
                                @php
                                    $statusMap = [
                                        ...
                                        'dang_su_dung' => [
                                            'label' => 'Đang Sử Dụng',
                                            'class' => 'bg-success text-white border-warning',
                                        ],
                                        'da_xac_nhan' => [
                                            'label' => 'Đã đặt cọc',
                                ...
                                {{-- Status Badge --}}
                                <span class="badge {{ $s['class'] }} fw-bold"
                                    style="font-size:18px; padding:0.6rem 1rem; line-height:1;">{{ $s['label'] }}</span>
                        ...
                        <div class="card-body p-4">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            ...
                                            <div class="d-flex gap-3 flex-wrap">
                                                ...
                                                <div>
                                                    <div class="fs-3 fw-bold text-primary">{{ $hoursUntilCheckIn % 24 }}
                                                    </div>
                            ...
                            {{-- Timeline Status --}}
                            <div class="mb-4">
                                <h6 class="mb-3"><i class="bi bi-activity me-2 text-primary"></i> Tiến trình đặt phòng
                                </h6>
                                <div class="booking-timeline">
                                    <div
                                        class="timeline-step {{ in_array($booking->trang_thai, ['dang_cho', 'dang_cho_xac_nhan', 'da_xac_nhan', 'dang_su_dung', 'hoan_thanh']) ? 'completed' : '' }}">
                                        ...
                                        <div class="timeline-content">
                                            <h6>Đặt phòng</h6>
                                            <small
                                                class="text-muted">{{ $formatDateVi($booking->created_at, 'd M Y H:i') }}</small>
                                        </div>
                                    </div>

                                    <div
                                        class="timeline-step {{ in_array($booking->trang_thai, ['da_xac_nhan', 'dang_su_dung', 'hoan_thanh']) ? 'completed' : ($booking->trang_thai === 'da_huy' ? 'cancelled' : '') }}">
                                        <div class="timeline-marker">
                                            <i
                                                class="bi {{ in_array($booking->trang_thai, ['da_xac_nhan', 'dang_su_dung', 'hoan_thanh']) ? 'bi-check-circle-fill' : ($booking->trang_thai === 'da_huy' ? 'bi-x-circle-fill' : 'bi-circle') }}"></i>
                                        </div>
                                        <div class="timeline-content">
                                    ...
                                    @if ($booking->trang_thai !== 'da_huy')
                                        <div
                                            class="timeline-step {{ in_array($booking->trang_thai, ['dang_su_dung', 'hoan_thanh']) ? 'completed' : '' }}">
                                            <div class="timeline-marker">
                                                <i
                                                    class="bi {{ in_array($booking->trang_thai, ['dang_su_dung', 'hoan_thanh']) ? 'bi-check-circle-fill' : 'bi-circle' }}"></i>
                                            </div>
                                            <div class="timeline-content">
                                                <h6>Nhận Phòng</h6>
                                                <small
                                                    class="text-muted">{{ $formatDateVi($booking->ngay_nhan_phong, 'd M Y') }}
                                                    14:00</small>
                                            </div>
                                        </div>

                                        <div
                                            class="timeline-step {{ $booking->trang_thai === 'hoan_thanh' ? 'completed' : '' }}">
                                            <div class="timeline-marker">
                                                <i
                                                    class="bi {{ $booking->trang_thai === 'hoan_thanh' ? 'bi-check-circle-fill' : 'bi-circle' }}"></i>
                                            </div>
                                            <div class="timeline-content">
                                                <h6>Trả phòng</h6>
                                                <small
                                                    class="text-muted">{{ $formatDateVi($booking->ngay_tra_phong, 'd M Y') }}
                                                    12:00</small>
                                            </div>
                                        </div>
                                    @endif
                            ...
                            <div class="row mb-4 g-3">
                                <div class="col-md-4">
                                    <div class="text-center text-md-start">
                                        <div class="text-muted small mb-1"><i class="bi bi-calendar-check me-1"></i> Nhận
                                            phòng</div>
                                        <div class="h6 mb-0 fw-bold">
                                            {{ $formatDateVi($booking->ngay_nhan_phong, 'D, d M Y') }}</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="text-center text-md-start">
                                        <div class="text-muted small mb-1"><i class="bi bi-calendar-x me-1"></i> Trả phòng
                                        </div>
                                        <div class="h6 mb-0 fw-bold">
                                            {{ $formatDateVi($booking->ngay_tra_phong, 'D, d M Y') }}</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="text-center text-md-end">
                                        <div class="text-muted small mb-1"><i class="bi bi-currency-dollar me-1"></i> Tổng
                                            tiền</div>
                                        @if (($booking->voucher_discount ?? 0) > 0)
                                            ...
                                            <div class="small text-muted text-decoration-line-through">
                                                {{ number_format($originalTotal, 0, ',', '.') }}đ</div>
                                        @endif
                                        <div class="h5 mb-0 fw-bold text-primary">
                                            {{ number_format($booking->tong_tien ?? ($booking->snapshot_total ?? 0), 0, ',', '.') }}
                                            VND</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card bg-light border-0 mb-4">
                                <div class="card-body">
                                    <h6 class="mb-3"><i class="bi bi-credit-card me-2 text-success"></i> Thông tin thanh
                                        toán</h6>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <strong class="text-success">{{ number_format($paidAmount, 0, ',', '.') }}
                                                    ₫</strong>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="d-flex justify-content-between">
                                                @php
                                                    ...
                                                    if ($remaining < 0) {
                                                        ...
                                                        $downgradeVoucher = \App\Models\Voucher::where(
                                                            'code',
                                                            'LIKE',
                                                            'DOWNGRADE%',
                                                        )
                                                ...
                                                @elseif($remaining > 0)
                                                    ...
                                                    <strong
                                                        class="text-danger">{{ number_format($remaining, 0, ',', '.') }}
                                                        ₫</strong>
                                                @else
                                                    {{-- Đã trả đủ --}}
                                                    <span class="text-muted">Còn lại:</span>
                                    ...
                                    @if ($booking->voucherUsages && $booking->voucherUsages->count() > 0)
                                        ...
                                        <div>
                                            <small class="text-muted d-block mb-2"><i
                                                    class="bi bi-ticket-perforated me-1"></i> Voucher đã sử dụng:</small>
                                    ...
                                    @php
                                        ...
                                        $cancelledRoomRefunds = \App\Models\RefundRequest::where(
                                            'dat_phong_id',
                                            $booking->id,
                                        )
                                    ...
                                    @if ($cancelledRoomRefunds->count() > 0)
                                        ...
                                        <div>
                                            <small class="text-muted d-block mb-2">
                                                <i class="bi bi-x-circle me-1 text-danger"></i> Phòng đã hủy
                                                ({{ $cancelledRoomRefunds->count() }}):
                                            </small>
                                                ...
                                                <div class="bg-danger bg-opacity-10 rounded px-2 py-2 mb-2">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center">
                                                            <span
                                                                class="small text-decoration-line-through text-muted me-2">
                                                                {{ $roomNameFromNote }}
                                                            </span>
                                                            <span
                                                                class="badge {{ $statusBadge }} small">{{ $statusLabel }}</span>
                                                        </div>
                                                        <span
                                                            class="small {{ $refundStatus === 'completed' ? 'text-success fw-semibold' : 'text-muted' }}">
                                                    ...
                                                    @if ($refundStatus === 'completed' && $proofImageUrl)
                                                        <div class="mt-2 pt-2 border-top border-danger border-opacity-25">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <small class="text-success fw-semibold me-2">Đã hoàn
                                                                    tiền:</small>
                                            ...
                                            @if ($totalCancelledRefund > 0)
                                                <div
                                                    ...
                                                    <span
                                                        class="text-success fw-bold">{{ number_format($totalCancelledRefund, 0, ',', '.') }}
                                                        ₫</span>
                                                </div>
                                            @endif
                                        </div>
                            ...
                            <div class="mb-4">
                                @php
                                    ...
                                    $canCancelIndividualRoom =
                                        $activeRoomsCount > 1 &&
                                        in_array($booking->trang_thai, ['dang_cho', 'da_xac_nhan']);
                                @endphp
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            @if ($hasVoucherForRoom)
                                                                <small
                                                                    class="text-muted text-decoration-line-through">{{ number_format($originalPricePerNight, 0, ',', '.') }}đ</small><br>
                                                                <span
                                                                    class="text-success fw-semibold">{{ number_format($pricePer, 0, ',', '.') }}
                                                                    VND</span>
                                                            @else
                                                                <span
                                                                    class="text-muted small">{{ number_format($pricePer, 0, ',', '.') }}
                                                                    VND</span>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td class="text-end">
                                                            @if ($hasVoucherForRoom)
                                                                <small
                                                                    class="text-muted text-decoration-line-through">{{ number_format($originalSubtotal, 0, ',', '.') }}đ</small><br>
                                                                <span
                                                                    class="fw-semibold text-primary">{{ number_format($subtotal, 0, ',', '.') }}
                                                                    VND</span>
                                                            @else
                                                                <span
                                                                    class="fw-semibold text-primary">{{ number_format($subtotal, 0, ',', '.') }}
                            ...
                            @if ($booking->datPhongAddons && $booking->datPhongAddons->count())
                                <div class="mb-4">
                                    <h6 class="mb-3 d-flex align-items-center"><i
                                            class="bi bi-plus-circle-fill me-2 text-info"></i> Dịch vụ bổ sung</h6>
                                    <div class="row g-2">
                                                ...
                                                <div
                                                    ...
                                                    <div class="text-end">
                                                        <div class="fw-bold text-primary">
                                                            {{ number_format($a->price ?? 0, 0, ',', '.') }} VND</div>
                            ...
                            {{-- Contact Information --}}
                            <div class="mb-4">
                                <h6 class="mb-3"><i class="bi bi-person-circle me-2 text-primary"></i> Thông tin liên hệ
                                </h6>
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="text-muted small mb-1">Tên người đặt</div>
                                        <div class="fw-semibold">{{ $booking->contact_name ?? ($user->name ?? 'N/A') }}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-muted small mb-1">Email</div>
                                        <div class="fw-semibold">{{ $booking->contact_email ?? ($user->email ?? 'N/A') }}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-muted small mb-1">Số điện thoại</div>
                                        <div class="fw-semibold">{{ $booking->contact_phone ?? ($user->phone ?? 'N/A') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-4">
                                                    <div class="card border-primary h-100">
                                                        ...
                                                        <div class="card-body p-3">
                                                            @if (!empty($cccdItem['front']) && \Illuminate\Support\Facades\Storage::disk('public')->exists($cccdItem['front']))
                                                                <div class="mb-3">
                                                                    <div class="text-center">
                                                                        <small class="text-muted d-block mb-2">Mặt
                                                                            trước</small>
                                                            ...
                                                            @endif
                                                            <small class="text-muted d-block mt-2 text-center">Click để xem
                                                                ảnh lớn</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="text-center">
                                                        ...
                                                        <img src="{{ \Illuminate\Support\Facades\Storage::url($cccdFront) }}"
                                                            ...
                                                            onclick="window.open(this.src, '_blank')">
                                                        <br><small class="text-muted mt-2 d-block">Click để xem ảnh
                                                            lớn</small>
                                                    </div>
                                                </div>
                                            @endif
                            ...
                            {{-- Overview --}}
                            <hr class="my-4">
                            <h6 class="mb-3 d-flex align-items-center"><i class="bi bi-list-check me-2 text-success"></i>
                                Tổng quan</h6>
                            <div class="row g-3 mb-4">
                                @php
                                    $adults =
                                        $meta['adults_input'] ??
                                        ($meta['computed_adults'] ?? ($meta['guests_adults'] ?? 0));
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="card border-0 bg-light h-100 text-center p-3">
                                        ...
                                        <div class="h6 fw-bold text-primary">{{ number_format($total, 0, ',', '.') }} VND
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            @if (in_array($booking->trang_thai, ['dang_cho', 'da_xac_nhan']))
                                <hr class="my-4">
                                <h6 class="mb-3 d-flex align-items-center"><i
                                        class="bi bi-shield-check me-2 text-secondary"></i> Chính sách hoàn tiền</h6>
                                        ...
                                        <div class="accordion-item border">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#policyDetails">
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="alert alert-info alert-sm mt-3 mb-0">
                                                        <small>
                                                            ...
                                                            <strong>Lưu ý:</strong> Khách hàng thanh toán 100% được ưu đãi
                                                            tỷ lệ hoàn tiền cao hơn khi hủy phòng.
                                                        </small>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-4">
                        <div class="alert alert-light border mb-3">
                            ...
                            <strong>Số tiền được hoàn:</strong> <span
                                class="text-success fs-5">{{ number_format($refundAmount, 0, ',', '.') }} ₫</span>
                        </div>
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <form action="{{ route('account.booking.cancel', $booking->id) }}" method="POST"
                            class="d-inline">
                            @csrf
        ...
        @if ($activeRoomsForModal->count() > 1)
            @foreach ($booking->datPhongItems as $roomItem)
                @php
                    ...
                    $roomPriceItem =
                        ($roomItem->gia_tren_dem ?? 0) * ($roomItem->so_dem ?? 1) * ($roomItem->so_luong ?? 1);
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                <div class="alert alert-warning border-0 mb-3">
                                    ...
                                    <strong>Lưu ý:</strong> Bạn đang hủy 1 phòng trong booking có nhiều phòng. Các phòng còn
                                ...
                                <div class="card border-secondary mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-2 small">
                                            ...
                                            <div class="col-6 text-end">
                                                <strong
                                                    class="text-success">{{ number_format($roomRefundEstimate, 0, ',', '.') }}
                                                    ₫</strong>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <p class="text-muted small mb-0">
                                    ...
                                    Số tiền hoàn thực tế sẽ được tính toán chính xác tại thời điểm hủy dựa trên chính sách
                                    hoàn tiền.
                                </p>
                            </div>
                            <div class="modal-footer border-0">
                                ...
                                <form
                                    action="{{ route('account.booking.cancel-room-item', ['id' => $booking->id, 'itemId' => $roomItem->id]) }}"
                    ...
                    <div class="modal-body p-4" style="max-height: 70vh; overflow-y: auto;">
                        ...
                        <div class="alert alert-info border-0 shadow-sm mb-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="small">
                                    <strong>Chính sách:</strong> Trước 24h Nhận phòng • Đổi phòng tăng giá: Thanh toán chênh
                                    lệch • Đổi phòng dưới giá: Nhận voucher • Miễn phí nếu cùng giá
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <h6 class="text-muted mb-3 d-flex align-items-center">
                                ...
                                @if ($booking->datPhongItems && $booking->datPhongItems->count() > 1)
                                    <span class="badge bg-primary ms-2">{{ $booking->datPhongItems->count() }}
                                        phòng</span>
                                @endif
                            </h6>
                                ...
                                <div class="row g-3">
                                    @foreach ($booking->datPhongItems as $index => $currentItem)
                                        @php
                                            ...
                                            $totalGuests =
                                                ($meta['computed_adults'] ?? 0) + ($meta['chargeable_children'] ?? 0);
                                            $guestsPerRoom = $currentItem->so_nguoi_o ?? 0;

                                            if ($guestsPerRoom == 0) {
                                                $totalRooms = $booking->datPhongItems
                                                    ? $booking->datPhongItems->count()
                                                    : 1;
                                                $guestsPerRoom =
                                                    $totalRooms > 0 ? ceil($totalGuests / $totalRooms) : $totalGuests;
                                            }
                                        ...
                                        <div class="col-lg-6">
                                            <div
                                                class="card border-2 border-primary h-100 shadow-sm hover-shadow transition">
                                                <div class="card-body p-3">
                                                    <div class="d-flex gap-3">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            @if ($currentRoom && $currentRoom->images && $currentRoom->images->count() > 0)
                                                                <img src="{{ \Illuminate\Support\Facades\Storage::url($currentRoom->images->first()->image_path) }}"
                                                                    alt="Room" class="rounded shadow-sm"
                                                        ...
                                                        <div class="flex-grow-1 min-width-0">
                                                            <h6 class="mb-2 fw-bold text-truncate">
                                                                <span
                                                                    class="text-primary">#{{ $currentRoom->ma_phong ?? 'N/A' }}</span>
                                                                <span
                                                                    class="text-muted small">{{ $currentRoomType->ten ?? 'N/A' }}</span>
                                                            </h6>

                                                            <div class="small text-muted mb-2">
                                                                <div class="mb-1">
                                                                    <i
                                                                        class="bi bi-people me-1"></i>{{ $currentRoomType->suc_chua ?? 2 }}
                                                                    người
                                                                    <span class="mx-1">•</span>
                                                                    <i class="bi bi-person-check-fill text-info me-1"></i>
                                                                    <strong
                                                                        class="text-dark">{{ $guestsPerRoom }}</strong>
                                                                    đặt
                                                                </div>
                                                                @if ($extraAdults > 0 || $extraChildren > 0)
                                                                    <small class="text-warning">
                                                                        <i class="bi bi-exclamation-circle me-1"></i>
                                                                        ({{ $extraAdults > 0 ? $extraAdults . 'người lớn' : '' }}{{ $extraAdults > 0 && $extraChildren > 0 ? ', ' : '' }}{{ $extraChildren > 0 ? $extraChildren . ' trẻ em' : '' }}
                                                                        vượt)
                                                                    </small>
                                                                @endif
                                                            </div>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-end">
                                                                <div class="small">
                                                                    ...
                                                                    @if ($extraCharge > 0)
                                                                        <div class="text-warning">
                                                                            <i
                                                                                class="bi bi-person-plus me-1"></i>+{{ number_format($extraCharge, 0, ',', '.') }}đ
                                                                            phụ thu
                                                                        </div>
                                                                    @else
                                                                        <div class="text-success">
                                                                            <i class="bi bi-check-circle me-1"></i>Không
                                                                            phụ thu khách
                                                                        </div>
                                                                    @endif
                                                                    @php
                                                                    ...
                                                                    @if ($weekendNights > 0)
                                                                        <div class="text-info">
                                                                            <i
                                                                                class="bi bi-calendar-event me-1"></i>{{ $weekendNights }}
                                                                            đêm cuối tuần (+10%)
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                                <div class="text-end">
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        $voucherForThisRoom =
                                                                            $currentItem->voucher_allocated ?? 0;
                                                                        $nights = $currentItem->so_dem ?? 1;
                                                                        $currentPricePerNight =
                                                                            $currentItem->gia_tren_dem ?? 0;

                                                                        // Original price = current price + voucher allocated per night
                                                                        $originalPricePerNight =
                                                                            $voucherForThisRoom > 0
                                                                                ? $currentPricePerNight +
                                                                                    $voucherForThisRoom /
                                                                                        max(1, $nights)
                                                                                : $currentPricePerNight;
                                                                        $hasVoucherForThisRoom =
                                                                            $voucherForThisRoom > 0;
                                                                    @endphp
                                                                    @if ($hasVoucherForThisRoom)
                                                                        <small
                                                                            class="text-muted text-decoration-line-through d-block">{{ number_format($originalPricePerNight, 0, ',', '.') }}đ</small>
                                                                    @endif
                                                                    <strong
                                                                        class="text-success fs-6">{{ number_format($currentPricePerNight, 0, ',', '.') }}đ</strong>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card border-0 shadow-sm bg-light">
                                <div class="card-body p-4">
                                    ...
                                    <div class="row g-3 mb-3">
                                            ...
                                            <div class="card bg-white border h-100">
                                                <div class="card-body p-3">
                                                    <small class="text-muted d-block mb-1"><i
                                                            class="bi bi-door-closed"></i> Phòng hiện tại</small>
                                                    <div class="fw-bold small" id="oldRoomName">
                                                        {{ $currentRoom->loaiPhong->ten ?? 'N/A' }}</div>
                                                    <small class="text-muted"
                                                        id="oldRoomCode">#{{ $currentRoom->ma_phong ?? 'N/A' }}</small>
                                                    ...
                                                    <div class="mt-2 pt-2 border-top" style="font-size: 0.75rem;">
                                                        ...
                                                        @if (isset($meta['weekend_nights']) && $meta['weekend_nights'] > 0)
                                                            <div class="d-flex justify-content-between text-info mb-1">
                                                                <span><i class="bi bi-calendar-event"></i> Cuối
                                                                    tuần:</span>
                                                        ...
                                                        @if ($currentExtraAdults > 0)
                                                            <div class="d-flex justify-content-between text-warning mb-1">
                                                                <span><i class="bi bi-person-plus"></i> Người lớn
                                                                    thêm:</span>
                                                                <span>{{ $currentExtraAdults }}
                                                                    ({{ number_format($currentExtraAdults * 150000) }}đ)</span>
                                                            </div>
                                                        @endif
                                                        @if ($currentExtraChildren > 0)
                                                            <div class="d-flex justify-content-between text-warning mb-1">
                                                                <span><i class="bi bi-person"></i> Trẻ em thêm:</span>
                                                                <span>{{ $currentExtraChildren }}
                                                                    ({{ number_format($currentExtraChildren * 60000) }}đ)</span>
                                                            </div>
                                                        @endif
                                                    </div>
                                        ...
                                        <div class="col-6">
                                            <div class="card bg-white border-primary border-2 h-100">
                                                <div class="card-body p-3">
                                                    <small class="text-muted d-block mb-1"><i class="bi bi-door-open"></i>
                                                        Phòng mới</small>
                                                    <div class="fw-bold text-primary small" id="newRoomName">Chưa chọn
                                                    </div>
                                                    ...
                                                    <div class="mt-2">
                                                        <span class="badge bg-primary small"
                                                            id="newRoomPricePerNight">0đ/đêm</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if ($booking->voucher_discount > 0)
                                        ...
                                        @endphp
                                        <div
                                            class="mb-3 p-3 bg-success bg-opacity-10 rounded border border-success border-opacity-25">
                                            ...
                                            <div class="small">
                                                ...
                                                <div class="d-flex justify-content-between mb-1">
                                                    ...
                                                    <strong
                                                        class="text-success">-{{ number_format($booking->voucher_discount, 0, ',', '.') }}đ</strong>
                                                </div>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center p-3 bg-white rounded">
                                        ...
                                        <h4 class="mb-0 text-success" id="newTotal">
                                            {{ number_format($booking->tong_tien ?? 0, 0, ',', '.') }}đ</h4>
                                    </div>

                                    {{-- Payment/Voucher Info --}}
                                    <div id="paymentInfoSection" class="mt-3 d-none">
                                        <div class="alert alert-warning mb-0 small">
                                            <h6 class="fw-semibold mb-2 small"><i class="bi bi-wallet2"></i> Thanh toán
                                            </h6>
                                            <div class="d-flex justify-content-between">
                                                <span>Đã cọc:</span>
                                    ...
                                    <div id="voucherInfoSection" class="mt-3 d-none">
                                        <div class="alert alert-success mb-0 small">
                                            <h6 class="fw-semibold mb-2 small"><i class="bi bi-gift"></i> Hoàn voucher
                                            </h6>
                                        ...
                                        <div class="card border-success">
                                            ...
                                            <div class="card-body p-3">
                                                <p class="text-muted small mb-3">
                                                    <i class="bi bi-info-circle me-1"></i>
                                                    Bạn có voucher hoàn tiề từ lần downgrade trước. Chọn voucher để giảm chi
                                                    phí nâng cấp.
                                                </p>
                                                ...
                                                <div id="selectedVouchersSummary" class="mt-3 d-none">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span class="badge bg-success fs-6"
                                                            id="totalVoucherDiscount">0đ</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function applyFilters() {
                ...
                if (typeFilter) {
                    filteredRooms = filteredRooms.filter(r => {
                        ...
                        if (!match) {
                            console.log(
                            `Room ${r.code} name "${r.name}" doesn't match "${typeFilter}"`); // DEBUG
                        }
                        return match;
                    });
                    ...
                    if (room.extra_charge && room.extra_charge > 0) {
                        surchargeHtml = `
                            <div class="small text-warning mb-1">
                                ...
                                <span class="text-muted">(${room.extra_adults || 0} người lớn, ${room.extra_children || 0} trẻ em)</span>
                            </div>
                        `;
                    }
            ...
            function selectRoom(roomId, price, wrapper) {
                ...
                const roomData = allAvailableRooms.find(r => r.id == roomId) || {
                    price: price
                };
            ...
            function updatePriceSummary(roomData) {
                ...
                if (selectedCard) {
                    ...
                    document.getElementById('newRoomPricePerNight').textContent = Math.round(newRoomPrice)
                    ...
                    if (breakdownEl) {
                        ...
                        if (roomData.extra_adults && roomData.extra_adults > 0) {
                            breakdownHtml += `
                                <div class="d-flex justify-content-between text-warning mb-1">
                                    <span><i class="bi bi-person-plus"></i> Người lớn thêm:</span>
                ...
                document.getElementById('newTotal').textContent = Math.round(newTotal).toLocaleString('vi-VN') +
                'đ';
                ...
                if (voucherDiscount > 0) {
                    ...
                    if (beforeVoucherElement) {
                        beforeVoucherElement.textContent = Math.round(priceBeforeVoucher).toLocaleString('vi-VN') +
                            'đ';
                    }
            ...
            document.getElementById('confirmChangeBtn').addEventListener('click', function() {
                ...
                const priceDiffPerNight = roomData.price_difference ?? (selectedRoomPrice -
                    currentRoomPrice);
                ...
                const selectedWrapper = document.querySelector(
                    `.room-card-wrapper[data-room-id="${selectedRoomId}"]`);
                ...
                if (priceDiff > 0) {
                    ...
                    showUpgradeConfirmation(selectedRoomCode, priceDiff, nights, oldRoomTotal, newRoomTotal,
                        currentBookingTotal, newBookingTotal);
                } else if (priceDiff < 0) {
                    // DOWNGRADE - Show voucher preview
                    showDowngradeConfirmation(selectedRoomCode, priceDiff, nights, oldRoomTotal,
                        newRoomTotal, currentBookingTotal, newBookingTotal);
                } else {
            ...
            function showUpgradeConfirmation(roomCode, priceDiff, nights, oldRoomTotal, newRoomTotal,
                currentBookingTotal, newBookingTotal) {
            ...
            function showDowngradeConfirmation(roomCode, priceDiff, nights, oldRoomTotal, newRoomTotal,
                currentBookingTotal, newBookingTotal) {
                const depositPct = {{ $booking->snapshot_meta['deposit_percentage'] ?? 50 }};
                const currentDeposit = {{ $booking->deposit_amount ?? 0 }};
                const voucherDiscount = {{ $booking->voucher_discount ?? 0 }}; // Voucher được giữ lại
            ...
            function recalculateWithVouchers() {
                ...
                if (paymentInfoEl) {
                    ...
                    const depositPct = {{ $meta['deposit_percentage'] ?? 50 }};
                    const currentDeposit = {{ $booking->deposit_amount ?? 0 }};
                    const newTotal = parseFloat(document.getElementById('newTotal').textContent.replace(/[^0-9]/g,
                        '')) || 0;
                    const newDepositRequired = newTotal * (depositPct / 100);
                    const basePaymentNeeded = Math.max(0, newDepositRequired - currentDeposit);
