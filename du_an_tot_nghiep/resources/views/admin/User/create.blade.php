    ...
    <div class="col-md-8 col-lg-6">
        <div class="card shadow-sm border-0 rounded">
            <div class="card-header bg-success text-white text-center py-3">
                <h5 class="mb-0 fw-bold">Thêm Khách Hàng Mới</h5>
                <small class="opacity-75">Điền thông tin để tạo tài khoản khách hàng mới</small>
            </div>
                ...
                <form action="{{ route('admin.user.store') }}" method="POST" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text small">Tên đầy đủ của khách hàng.</div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text small">Email hợp lệ để đăng nhập.</div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text small">Số điện thoại để liên hệ.</div>
                    </div>
            ...
            <div class="card-footer bg-light text-center py-2 border-0">
                <small class="text-muted">Bằng cách thêm khách hàng, bạn đồng ý với <a href="#" class="text-decoration-none fw-semibold">chính sách bảo mật</a> của công ty. Các trường có dấu * là bắt buộc.</small>
            </div>
        </div>
    </div>
</div>
