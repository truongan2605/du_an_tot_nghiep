...
<div class="mb-3">
    ...
    <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $voucher->name ?? '') }}"
        required>
</div>
...
<div class="mb-3">
    ...
    <input type="date" name="end_date" id="end_date" class="form-control"
        value="{{ old(
            'end_date',
            isset($voucher) && $voucher->end_date ? \Illuminate\Support\Carbon::parse($voucher->end_date)->format('Y-m-d') : '',
        ) }}"
        required>
</div>
