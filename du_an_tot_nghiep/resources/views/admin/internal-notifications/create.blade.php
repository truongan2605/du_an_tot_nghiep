                ...
                Chọn mẫu để tự động điền nội dung JSON
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="notification_title" name="notification_title" 
                                   value="{{ old('notification_title') }}" placeholder="Ví dụ: Họp team quan trọng" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="notification_message" name="notification_message" rows="4" 
                                      placeholder="Ví dụ: Họp team lúc 14:00 ngày mai tại phòng họp A. Vui lòng chuẩn bị báo cáo tiến độ dự án." required>{{ old('notification_message') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="notification_link" name="notification_link" 
                                   value="{{ old('notification_link') }}" placeholder="Ví dụ: /admin/meetings hoặc https://example.com">
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
