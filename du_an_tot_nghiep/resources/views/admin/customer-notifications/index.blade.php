...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">
                <i class="fas fa-users me-2 text-primary"></i>Thông báo khách hàng
            </h1>
            <p class="text-muted mb-0">Quản lý thông báo gửi cho khách hàng</p>
        </div>
        <div class="btn-group">
            <a href="{{ route('admin.customer-notifications.create') }}" class="btn btn-primary">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.customer-notifications.index') }}">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <label for="nguoi_nhan_id" class="form-label">Khách hàng</label>
                        <select class="form-select" id="nguoi_nhan_id" name="nguoi_nhan_id">
                            <option value="">Tất cả khách hàng</option>
                            @foreach($customers as $customer)
                                <option value="{{ $customer->id }}" {{ request('nguoi_nhan_id') == $customer->id ? 'selected' : '' }}>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">Danh sách thông báo khách hàng</h5>
        </div>
        <div class="card-body p-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">{{ $notification->nguoiNhan ? $notification->nguoiNhan->email : 'N/A' }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            @endif
                                            <form method="POST" action="{{ route('admin.customer-notifications.destroy', $notification) }}" 
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <h5 class="text-muted">Không có thông báo khách hàng nào</h5>
                    <p class="text-muted">Chưa có thông báo nào được gửi cho khách hàng.</p>
                    <a href="{{ route('admin.customer-notifications.create') }}" class="btn btn-primary">
