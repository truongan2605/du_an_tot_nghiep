...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb-3">
            ...
            <a href="{{ route('admin.blog.categories.create') }}" class="btn btn-primary">+ Thêm</a>
        </div>
        <div class="card">
            <table class="table">
                <thead>
                ...
                <tbody>
                    @foreach ($items as $i => $it)
                        <tr>
                            ...
                            <td>{{ $it->slug }}</td>
                            <td class="text-end">
                                <a href="{{ route('admin.blog.categories.edit', $it) }}"
                                    class="btn btn-sm btn-outline-primary">Sửa</a>
                                <form action="{{ route('admin.blog.categories.destroy', $it) }}" method="POST"
