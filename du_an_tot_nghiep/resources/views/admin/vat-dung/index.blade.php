        ...
        @if($vatdungs->count() > 0)
                        ...
                        <tr>
                            ...
                            <td>
                                @if($vatdung->icon && Storage::disk('public')->exists($vatdung->icon))
                                    <img src="{{ Storage::url($vatdung->icon) }}" 
                                         alt="{{ $vatdung->ten }}" 
                                         class="img-thumbnail" 
                            ...
                            <td>{{ $vatdung->ten }}</td>
                            <td>{{ number_format($vatdung->gia, 0, ',', '.') }}</td>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <form action="{{ route('admin.vat-dung.destroy', $vatdung) }}" 
                                          method="POST" 
                                          class="d-inline"
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div class="text-muted">
                    Hiển thị {{ $vatdungs->firstItem() }}–{{ $vatdungs->lastItem() }} trong tổng {{ $vatdungs->total() }} dịch vụ
                </div>
                <div>
