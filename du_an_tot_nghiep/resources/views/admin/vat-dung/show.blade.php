...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold text-primary"><i class="fas fa-box me-2"></i>Chi tiết vật dụng</h2>
    <div>
...
{{-- Thông tin và hình ảnh song song --}}
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 border-end">
                ...
                <table class="table table-borderless mb-0">
                    ...
                    <tr>
                        <td class="fw-semibold">Tên vật dụng:</td>
                        <td>{{ $vat_dung->ten }}</td>
                    </tr>
                    <tr>
                    ...
                    @if(isset($vat_dung->gia))
                    <tr>
                        <td class="fw-semibold">Giá:</td>
                        <td>{{ number_format($vat_dung->gia, 0, ',', '.') }} VND</td>
                    </tr>
                    @endif
                    <tr>
            ...
            <div class="col-md-6 text-center">
                ...
                @if ($vat_dung->icon)
                    <div class="border rounded p-2 bg-light shadow-sm d-inline-block">
                        <img src="{{ asset('storage/' . $vat_dung->icon) }}" 
                             alt="Ảnh vật dụng" 
